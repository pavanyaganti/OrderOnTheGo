...
const NewProduct = () => {
  ...
  const handleNewProduct = async() =>{
    try{
      await axios.post('http://localhost:6001/add-new-product', { restaurantId: restaurant._id, productName, productDescription, productMainImg, productCategory, productMenuCategory, productNewCategory, productPrice, productDiscount });
      alert('product added');
      setProductName('');
        ...
        <div className="new-product-container">
          ...
          <div className="new-product-body">
            ...
            <div className="form-floating mb-3">
              <input type="file" className="form-control" id="floatingNewProduct1" onChange={(e)=>{
              ...
              <label htmlFor="floatingNewProduct1">Thumbnail image (upload)</label>
            </div>
